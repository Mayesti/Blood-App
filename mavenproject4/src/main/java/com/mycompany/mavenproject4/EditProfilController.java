...
import static com.mycompany.mavenproject4.UserLogin.email;
import static com.mycompany.mavenproject4.UserLogin.nama;
...
public class EditProfilController implements Initializable {
    ...
    private void btnsimpan(ActionEvent event) throws IOException{
        ...
        if(!namabaru.isEmpty() && !usernamebaru.isEmpty() && !emailbaru.isEmpty()){
            String sql = "update user set username='"+usernamebaru+"', nama='"+namabaru+"', email='"+emailbaru+"' where username='"+username+"'"; 
            try{
